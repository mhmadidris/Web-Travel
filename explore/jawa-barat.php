...
require '../config.php';
$paket = query("SELECT * FROM paket WHERE provinsi='Jawa Barat'");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>BransKuy | Jawa Barat</title>
...
?>
        ...
        <div class="overlay">
            <div class="flex">
                ...
                <div class="kanan">
                    <p>West Java (Indonesian: Jawa Barat; Sundanese: Jawa Kulon) is a province of Indonesia on the
                        western
                        part of the island of Java, with its provincial capital in Bandung. West Java is bordered by the
                        province of
                        Banten and the country's capital region of Jakarta to the west, the Java Sea to the north, the
                        province of
                        Central Java to the east and the Indian Ocean to the south. The province is the native homeland
                        of
                        the
                        Sundanese people, the second-largest ethnic group in Indonesia after the Javanese.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="tujuan">
        <ul>
            ...
            <li><i class="fas fa-caret-right"></i></li>
            <li><a href="explore/jawa-barat.php">Jawa Barat</a></li>
        </ul>
    </div>
    <!-- start search -->
    <div class="boxSearch">
