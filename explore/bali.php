...
require '../config.php';
$paket = query("SELECT * FROM paket WHERE provinsi='Bali'");
?>
<!DOCTYPE html>
<html lang="en">
...
?>
        ...
        <div class="overlay">
            <div class="flex">
                ...
                <div class="kanan">
                    <p>Bali adalah sebuah provinsi di Indonesia yang ibu kota provinsinya bernama Denpasar.
                        Secara geografis, Bali terletak di antara Pulau Jawa dan Pulau
                        Lombok. Mayoritas penduduk Bali adalah pemeluk agama Hindu. Di dunia, Bali terkenal sebagai
                        tujuan pariwisata dengan keunikan berbagai hasil seni-budayanya, khususnya bagi para wisatawan
                        Jepang dan Australia. Bali juga dikenal dengan julukan Pulau Dewata dan Pulau Seribu Pura.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="tujuan">
        <ul>
            ...
            <li><i class="fas fa-caret-right"></i></li>
            <li><a href="explore/bali.php">Bali</a></li>
        </ul>
    </div>
    <?php if ($paket != null) {?>
    <!-- start search -->
    ...
    <?php }?>
    <?php if ($paket == null) {?>
    <div class="container-back-error"">
        <div class=" error">
        <i class="fas fa-plane-slash"></i>
        <p>Jalan - jalan ke Tasikmalaya,</p>
        <p>Mohon maaf paket belum tersedia.</p>
    </div>
    </div>
    <?php }?>
